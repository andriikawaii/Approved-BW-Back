    ...
    'types' => [
        ...
        'hero' => [
            ...
            'schema' => [
                ...
                'background_image_alt' => 'nullable|string|max:125',
                ...
                'badges.*.url' => 'nullable|string|max:255',
                'badges.*.is_primary' => 'nullable|boolean',
            ],
            'defaults' => [
                'eyebrow' => null,
                'headline' => '',
        ...
        'rich_text' => [
            ...
            'schema' => [
                ...
                'highlight_text' => 'nullable|string|max:80',
                ...
                'style_variant' => 'nullable|in:default,legal,faq,process,cards,links,prose,financing_strip',
        ...
        'consultation_cards_split' => [
            'type' => 'consultation_cards_split',
            'label' => 'Consultation Cards Split',
            'description' => 'Two-card comparison section with intro copy and per-card image, alt, title, and paragraph.',
            'schema' => [
                'eyebrow' => 'nullable|string|max:60',
                'title' => 'nullable|string|max:160',
                'highlight_text' => 'nullable|string|max:80',
                ...
                'cards.*.description' => 'required|string|max:1000',
                'cards.*.image' => 'required|string|max:255',
                'cards.*.image_alt' => 'nullable|string|max:125',
            ],
            'defaults' => [
                'eyebrow' => 'Your Choice',
                'title' => 'On-Site vs. Remote Consultations',
                'highlight_text' => 'Consultations',
                'subtitle' => 'Choose the consultation format that best fits your project and schedule.',
                'cards' => [
                    [
        ...
        'testimonials' => [
            ...
            'schema' => [
                ...
                'items.*.avatar_alt' => 'nullable|string|max:125',
            ...
            'defaults' => [
                ...
                'layout' => 'carousel',
                'items' => [
                    ['name' => '', 'location' => '', 'quote' => '', 'avatar' => null, 'avatar_alt' => null, 'rating' => 5, 'year' => null],
                ],
            ],
        ],
        ...
        'project_highlights' => [
            ...
            'schema' => [
                ...
                'items.*.image_alt' => 'nullable|string|max:125',
                'items.*.url' => 'nullable|string|max:255',
            ...
            'defaults' => [
                ...
                'subtitle' => null,
                'items' => [
                    ['title' => '', 'description' => null, 'image' => null, 'image_alt' => null, 'url' => null, 'link' => null, 'tag' => null],
                ],
            ],
        ],
        ...
        'logo_strip' => [
            ...
            'schema' => [
                ...
                'items.*.logo_alt' => 'nullable|string|max:125',
                'items.*.url' => 'nullable|string|max:255',
            ],
            'defaults' => [
                ...
                'subtitle' => null,
                'items' => [
                    ['name' => 'Cambria', 'logo' => '', 'logo_alt' => null, 'url' => null],
                ],
            ],
        ],
        ...
        'accordion_list' => [
            ...
            'description' => 'Intro copy with expandable cards for neighborhoods, FAQs, or local notes.',
            'schema' => [
                'eyebrow' => 'nullable|string|max:60',
                'title' => 'nullable|string|max:160',
                'highlight_text' => 'nullable|string|max:80',
                ...
                'items' => 'required|array|min:1',
                'items.*.title' => 'required|string|max:120',
                'items.*.content' => 'required|string|max:4000',
            ],
            'defaults' => [
                'eyebrow' => null,
        ...
        'areas_served' => [
            ...
            'schema' => [
                ...
                'counties.*.image_alt' => 'nullable|string|max:125',
                'counties.*.url' => 'nullable|string|max:255',
                'counties.*.phone' => 'nullable|string|max:40',
                'counties.*.description' => 'nullable|string|max:500',
                'counties.*.towns' => 'required|array|min:1',
                'counties.*.towns.*' => 'required|string|max:60',
                'counties.*.extra_towns' => 'nullable|array',
                'counties.*.extra_towns.*' => 'required_with:counties.*.extra_towns|string|max:60',
                'counties.*.town_links' => 'nullable|array',
                'counties.*.cta_label' => 'nullable|string|max:80',
            ],
            'defaults' => [
                'eyebrow' => null,
                ...
                'counties' => [
                    [
                        ...
                        'phone' => null,
                        'description' => null,
                        'towns' => ['Greenwich', 'Stamford', 'Norwalk'],
                        'extra_towns' => [],
                        'town_links' => [],
                        'cta_label' => null,
                    ],
                    [
                        ...
                        'phone' => null,
                        'description' => null,
                        'towns' => ['New Haven', 'Orange', 'Milford'],
                        'extra_towns' => [],
                        'town_links' => [],
                        'cta_label' => null,
                    ],
        ...
        'process_steps' => [
            ...
            'schema' => [
                ...
                'steps.*.image' => 'nullable|string|max:255',
                'steps.*.image_alt' => 'nullable|string|max:125',
                'steps.*.summary' => 'nullable|string|max:2000',
                'steps.*.more' => 'nullable|array',
                'steps.*.more.*' => 'nullable|string|max:2000',
            ],
            'defaults' => [
                'title' => 'From First Call to Finished Project',
                'subtitle' => null,
                'eyebrow' => 'The 5-Step Framework',
                'steps' => [
                    ['title' => 'Consultation', 'short' => 'We visit your home or meet via Zoom', 'description' => 'We discuss goals, assess the space, and answer questions.', 'image' => null, 'image_alt' => null, 'summary' => null, 'more' => []],
                    ['title' => 'Planning', 'short' => 'Detailed scope, timeline, and proposal', 'description' => 'You receive a clear proposal with what’s included and how long it takes.', 'image' => null, 'image_alt' => null, 'summary' => null, 'more' => []],
                    ['title' => 'Selections', 'short' => 'Materials and finish selections', 'description' => 'We guide you through cabinets, counters, tile, flooring, and options.', 'image' => null, 'image_alt' => null, 'summary' => null, 'more' => []],
                    ['title' => 'Build', 'short' => 'Construction with daily communication', 'description' => 'We show up when we say we will, keep the site clean, and update you daily.', 'image' => null, 'image_alt' => null, 'summary' => null, 'more' => []],
                    ['title' => 'Walkthrough', 'short' => 'Final review before we call it done', 'description' => 'We walk through everything together and address anything that needs attention.', 'image' => null, 'image_alt' => null, 'summary' => null, 'more' => []],
                ],
            ],
        ],
        ...
        'before_after' => [
            ...
            'schema' => [
                ...
                'items.*.before_image_alt' => 'nullable|string|max:125',
                'items.*.after_image' => 'required|string|max:255',
                'items.*.after_image_alt' => 'nullable|string|max:125',
        ...
        'services_grid' => [
            ...
            'schema' => [
                ...
                'highlight_text' => 'nullable|string|max:80',
                'subtitle' => 'nullable|string|max:255',
                'initial_visible_count' => 'nullable|integer|min:1|max:12',
                'toggle_label' => 'nullable|string|max:80',
                'toggle_less_label' => 'nullable|string|max:80',

                'cta_card' => 'nullable|array',
                'cta_card.title' => 'nullable|string|max:120',
                'cta_card.body' => 'nullable|string|max:255',
                'cta_card.label' => 'nullable|string|max:60',
                'cta_card.url' => 'nullable|string|max:255',
                'cta_card.subtext' => 'nullable|string|max:120',

                'items' => 'required|array|min:1',
                'items.*.title' => 'required|string|max:80',
                'items.*.summary' => 'nullable|string|max:255',
                'items.*.image' => 'nullable|string|max:255',
                'items.*.image_alt' => 'nullable|string|max:125',
                'items.*.url' => 'required|string|max:255',
                'items.*.cta_label' => 'nullable|string|max:40',
                'items.*.price' => 'nullable|string|max:40',
                'items.*.timeline' => 'nullable|string|max:40',
            ...
            'defaults' => [
                ...
                'highlight_text' => null,
                'subtitle' => null,
                'initial_visible_count' => null,
                'toggle_label' => null,
                'toggle_less_label' => null,
                'cta_card' => [
                    'title' => null,
                    'body' => null,
                    'label' => null,
        ...
        'areas_we_serve_cards' => [
            ...
            'defaults' => [
                ...
                'items' => [
                    ['title' => 'Fairfield County', 'image' => null, 'image_alt' => null, 'url' => '/fairfield-county/'],
                    ['title' => 'New Haven County', 'image' => null, 'image_alt' => null, 'url' => '/new-haven-county/'],
                ],
            ],
        ],
        ...
        'lead_form' => [
            ...
            'schema' => [
                ...
                'images.*.alt' => 'nullable|string|max:125',
                ...
                'fields.*.type' => 'required|in:text,email,tel,select,textarea,file,checkbox_group,radio_group',
                'fields.*.required' => 'boolean',
                'fields.*.placeholder' => 'nullable|string|max:120',
                'fields.*.help_text' => 'nullable|string|max:120',
        ...
        'team_members' => [
            ...
            'schema' => [
                ...
                'members.*.image_alt' => 'nullable|string|max:125',
            ...
            'defaults' => [
                ...
                'subtitle' => null,
                'members' => [
                    ['name' => '', 'position' => '', 'image' => null, 'image_alt' => null, 'bio' => ''],
                ],
            ],
        ],
        ...
        'service_areas' => [
            ...
            'defaults' => [
                ...
                'subtitle' => null,
                'counties' => [
                    ['county_name' => 'Fairfield County', 'image' => null, 'image_alt' => null, 'cities' => ['Greenwich']],
                ],
                'show_map' => false,
                'map_embed' => null,
            ],
        ...
        'service_intro_split' => [
            ...
            'schema' => [
                ...
                'image_main_alt' => 'nullable|string|max:125',
                'image_secondary' => 'nullable|string|max:255',
                'image_secondary_alt' => 'nullable|string|max:125',
        ...
        'before_after_grid' => [
            ...
            'description' => 'Project showcase with a single image and testimonials.',
            'schema' => [
                'title' => 'nullable|string|max:120',
                'subtitle' => 'nullable|string|max:255',
                'projects' => 'required|array|min:1',
                'projects.*.image' => 'nullable|string|max:255',
                'projects.*.image_alt' => 'nullable|string|max:125',
            ...
            'defaults' => [
                ...
                'subtitle' => null,
                'projects' => [
                    ['image' => null, 'image_alt' => null, 'location' => '', 'description' => '', 'testimonial_quote' => null],
                ],
            ],
        ],
        ...
        'before_after_showcase' => [
            ...
            'schema' => [
                ...
                'before_image_alt' => 'nullable|string|max:125',
                'after_image' => 'nullable|string|max:255',
                'after_image_alt' => 'nullable|string|max:125',
            ],
            'defaults' => [
                'section_label' => null,
                'headline' => null,
        ...
        'case_study_highlight' => [
            ...
            'defaults' => [
                ...
                'subtitle' => null,
                'items' => [
                    ['title' => '', 'summary' => null, 'image' => null, 'image_alt' => null, 'url' => ''],
                ],
            ],
        ],
