    ...
    'types' => [
        ...
        'project_highlights' => [
            ...
            'defaults' => [
                ...
                'subtitle' => null,
                'items' => [
                    ['title' => '', 'description' => null, 'image' => null, 'image_alt' => null, 'url' => null, 'tag' => null],
                ],
            ],
        ],
        ...
        'before_after_grid' => [
            ...
            'schema' => [
                ...
                'projects.*.before_image_alt' => 'nullable|string|max:125',
                'projects.*.after_image' => 'nullable|string|max:255',
                'projects.*.after_image_alt' => 'nullable|string|max:125',
            ...
            'defaults' => [
                ...
                'subtitle' => null,
                'projects' => [
                    ['before_image' => null, 'before_image_alt' => null, 'after_image' => null, 'after_image_alt' => null, 'location' => '', 'description' => '', 'testimonial_quote' => null],
                ],
            ],
        ],
