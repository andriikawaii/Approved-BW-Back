<div class="p-6 md:p-8 space-y-6">
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">llms.txt</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
                Optional fajl za LLM crawler-e. Keširamo sadržaj.
            </p>
        </div>
    ...
    <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5">
        <div class="text-sm text-zinc-600 dark:text-zinc-300">
            Cache key: <span class="font-mono">seo:llms.txt</span>
        </div>
        <div class="text-sm text-zinc-500 dark:text-zinc-400 mt-2">
            Public endpoint: <span class="font-mono">/llms.txt</span>
        </div>
    </div>
</div>
