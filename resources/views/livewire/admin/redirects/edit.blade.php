<div class="min-h-screen bg-gray-50 dark:bg-zinc-900">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Redirect</h1>
            <p class="text-sm text-gray-500 dark:text-zinc-400 mt-1">
                Update redirect destination, code or status.
            </p>
        </div>
        ...
        <div class="mt-6 bg-white dark:bg-zinc-800 rounded-2xl border border-gray-200 dark:border-zinc-700 shadow-sm p-6">
            <div class="text-sm text-gray-700 dark:text-zinc-200">
                <div class="flex items-center justify-between">
                    <span class="text-gray-500 dark:text-zinc-400">Hits</span>
                    <span class="font-semibold">{{ number_format($redirect->hits) }}</span>
                </div>
                <div class="flex items-center justify-between mt-2">
                    <span class="text-gray-500 dark:text-zinc-400">Created</span>
                    <span class="font-semibold">{{ optional($redirect->created_at)->format('M d, Y H:i') }}</span>
                </div>
                <div class="flex items-center justify-between mt-2">
                    <span class="text-gray-500 dark:text-zinc-400">Updated</span>
                    <span class="font-semibold">{{ optional($redirect->updated_at)->format('M d, Y H:i') }}</span>
                </div>
            </div>
        </div>
