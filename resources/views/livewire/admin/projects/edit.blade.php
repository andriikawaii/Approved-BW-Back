<div class="p-6 max-w-3xl space-y-6">
    <div class="flex items-center justify-between">
        <flux:heading size="lg">Edit Case Study</flux:heading>
    ...
    <form wire:submit="save" class="space-y-5">
        ...
        <div class="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-5 space-y-4">
            ...
            <flux:input label="Title" wire:model="title" placeholder="e.g. Kitchen Remodel in Greenwich" required />
            @error('title') <p class="text-xs text-red-500">{{ $message }}</p> @enderror

            <flux:input label="Slug" wire:model="slug" placeholder="kitchen-remodel-greenwich" required />
