@php
    ...
    $fieldHelpers = [
        ...
        'style_variant' => 'Semantic style preset for frontend rendering',
        'surface' => 'Section background/surface style',
        'container_width' => 'Content width inside the section',
        'spacing' => 'Vertical spacing density',
        'anchor_id' => 'Optional in-page anchor (letters, numbers, hyphen)',
