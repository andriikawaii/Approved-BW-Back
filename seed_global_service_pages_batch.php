...
$specFiles = [
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\01-kitchen.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\02-bathroom.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\03-basement.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\04-additions.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\05-flooring.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\06-painting.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\07-carpentry.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\08-attic.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\09-decks.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\10-design-planning.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\global-pages\\11-comfort-accessibility.md',
];
...
function isDecorativeLine(string $line): bool
{
    $trimmed = trim($line);
    if ($trimmed === '') {
        return false;
...
function extractValueAfterLabel(string $text, string $labelPattern): ?string
{
...
function findSectionSegment(string $text, array $startPatterns, array $endPatterns): string
{
    $startPos = null;
    $startLen = 0;
...
function parseContentBlocks(string $contentSegment): array
{
    $lines = explode("\n", $contentSegment);
    $filtered = [];
    $h1 = null;
    ...
    foreach ($filtered as $line) {
        ...
        if (!$seenH2 && $trimmed === 'Intro' && trim(implode("\n", $currentLines)) === '') {
            $currentTitle = 'Intro';
            continue;
        }
...
function parseCta(string $ctaSegment): array
{
    $lines = explode("\n", $ctaSegment);
    $clean = [];
...
function parseSpec(string $filePath): array
{
    if (!is_file($filePath)) {
    ...
    $seoTitle = extractValueAfterLabel($text, '/^Meta Title[^\n]*:\s*$/mi');
    ...
    $seoDescription = extractValueAfterLabel($text, '/^Meta Description[^\n]*:\s*$/mi');
    ...
    $contentSegment = findSectionSegment(
        $text,
    ...
    $content = parseContentBlocks($contentSegment);
    $h1 = $content['h1'];
...
function chooseSectionType(array $allowed, array $candidates): ?string
{
...
foreach ($specFiles as $filePath) {
    ...
    $heroType = chooseSectionType($allowed, ['service_hero', 'hero', 'page_hero', 'hero_service_location']);
    if (!$heroType) {
    ...
    $ctaType = chooseSectionType($allowed, ['cta_block', 'cta_dark_band']);
    if (!$ctaType) {
