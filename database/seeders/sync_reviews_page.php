...
$pagePayload = [
    'full_path' => '/reviews',
    'template_key' => 'testimonials_page',
    'status' => 'published',
    'published_at' => now(),
    'seo_title' => 'Customer Reviews for CT Remodeling | BuiltWell CT',
    'seo_description' => 'Verified customer reviews for BuiltWell CT. Real feedback from homeowners across Fairfield and New Haven Counties. See why CT clients trust us.',
    'canonical_url' => 'https://buildwellct.com/reviews/',
];
...
$sections = [
    [
        'type' => 'hero',
        'data' => [
            'headline' => 'Customer Reviews for BuiltWell CT',
            'title' => 'Customer Reviews for BuiltWell CT',
            'title_highlight' => 'CT',
            'subheadline' => 'Real projects, real feedback from homeowners across Fairfield and New Haven County.',
            'subtitle' => 'Real projects, real feedback from homeowners across Fairfield and New Haven County.',
    ...
    [
        ...
        'data' => [
            'eyebrow' => 'Reviews',
            'title' => 'Why Connecticut Homeowners Trust BuiltWell',
            'title_highlight' => 'Trust BuiltWell',
            'style_variant' => 'intro',
            'paragraphs' => [
                'BuiltWell maintains a 4.9 Google rating across 100+ completed remodeling projects in Fairfield and New Haven County, with consistent feedback on punctuality, communication, and quality.',
                "A remodeling contractor's reputation is built project by project, on whether we showed up when we said we would, communicated clearly when something changed, and handed over work that matched what was agreed on. The feedback below reflects that. These are real projects completed for real homeowners across Connecticut.",
            ],
        ],
    ],
    [
        ...
        'data' => [
            ...
            'subtitle' => 'Every testimonial below is tied to a documented project with a specific scope, timeline, and location across Fairfield and New Haven County, Connecticut. We link to the full case study for each one so you can read the details, not just the quote.',
            ...
            'cards' => [
                ...
                [
                    ...
                    'location' => 'Milford, CT',
                    'badge' => 'Kitchen Remodeling',
                    'description' => 'This <a href="/kitchen-remodeling/">kitchen remodel</a> included new cabinets, countertops, appliances, and LVP <a href="/flooring/">flooring</a> extended through the adjacent living space. Six weeks, on schedule, with daily cleanup that kept the rest of the home livable throughout construction.',
                ],
            ],
        ],
    ],
    [
        ...
        'data' => [
            ...
            'style_variant' => 'leave_review',
            'paragraphs' => [
                'Past BuiltWell customers can leave a review on Google to help other Connecticut homeowners find a licensed, reliable remodeling contractor in Fairfield or New Haven County. Honest reviews from real customers are how a company like ours builds its reputation over time.',
                'We read every review. We take the feedback seriously. And we are grateful to the customers who take the time to write one.',
            ],
            'cta' => [
    ...
    [
        ...
        'data' => [
            ...
            'title' => 'What Consistent Feedback Looks Like',
            'title_highlight' => 'Looks Like',
            'style_variant' => 'feedback',
            'intro_paragraphs' => [
                'Across 100+ completed projects in Connecticut, three themes appear in nearly every BuiltWell review: on-time arrival, daily communication, and clean job sites throughout construction.',
                'These are not about tile patterns or cabinet finishes. They are about how the project was managed: we showed up when we said we would, we communicated when something needed to be communicated, and we cleaned up at the end of every day. These things matter to homeowners more than most contractors seem to understand.',
            ],
            'subsections' => [
                [
            ...
            'closing' => 'View all completed projects on our <a href="/case-studies/">case studies page</a>, or learn more about our five-step <a href="/process/">process</a>. Ready to discuss your project? <a href="/contact/">Contact us</a> or <a href="/free-consultation/">book a free consultation</a>.',
        ],
    ],
    [
        'type' => 'lead_form',
        'data' => [
            ...
            'subtitle' => 'On-site or remote (Google Meet or Zoom). Fairfield County: (203) 919-9616 | New Haven County: (203) 466-9148',
            'images' => [
