...
$pagePayload = [
    'full_path' => '/kitchen-remodeling/new-haven-ct',
    'template_key' => 'service_town',
    'status' => 'published',
    'published_at' => now(),
    'seo_title' => 'Kitchen Remodeling in New Haven, CT | BuiltWell CT',
    'seo_description' => 'Kitchen remodeling in New Haven, CT, from $25,000 to $150,000+. Pre-war and Victorian specialists. Licensed contractor. Call (203) 466-9148.',
    'canonical_url' => null,
];
...
$sections = [
    [
        ...
        'data' => [
            'headline' => 'Kitchen Remodeling in New Haven, CT',
            'subheadline' => 'Licensed kitchen remodeling contractor serving New Haven, CT - pre-war and Victorian specialists. Full-service renovations from $25,000 to $150,000+.',
            'background_image' => '/images/headers/kitchen-remodeling-header.jpg',
            'primary_cta' => ['label' => 'Free Estimate', 'url' => '#contact'],
            'secondary_cta' => ['label' => 'Call Now', 'url' => 'tel:2034669148'],
        ],
    ],
    [
        'type' => 'trust_bar',
    ...
    [
        'type' => 'rich_text',
        'data' => $rich(
            "New Haven's Kitchen Remodeling Contractor",
            ...
            ['highlight_text' => 'New Haven, CT', 'align' => 'center']
        ),
    ],
    [
        'type' => 'service_intro_split',
        'data' => [
            'title' => 'What Is Included in a Kitchen Remodel in New Haven',
            'content' => implode("\n\n", [
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Kitchen Remodeling Cost in New Haven, CT',
            'subtitle' => 'Kitchen remodeling in New Haven ranges from $25,000 for a basic cabinet and countertop update to $150,000 or more for a high-end renovation. Pre-war homes typically add $15,000 to $40,000 in remediation costs.',
            'columns' => ['Scope', 'Cost Range', "What's Typically Included"],
            'rows' => [
                ['label' => 'Basic Refresh', 'price' => '$25,000-$50,000', 'notes' => 'Cabinet refacing or stock cabinets, new countertops, updated appliances, paint'],
                ...
                ['label' => 'Pre-War Premium', 'price' => '+$15,000-$40,000', 'notes' => 'Lead abatement, knob-and-tube rewire, asbestos removal, steam heat system modifications'],
            ],
        ],
    ],
    [
    ...
    [
        ...
        'data' => [
            ...
            'steps' => [
                ['title' => 'Consultation', 'short' => 'Visit your New Haven home or connect by video', 'description' => 'We visit your New Haven home or connect via Google Meet or Zoom to discuss your goals, assess the space, and answer your questions. No charge. No obligation. We look at the layout, note the age of the home, check for visible knob-and-tube wiring, assess the electrical panel, and identify pre-war conditions that will affect scope and budget.'],
                ['title' => 'Planning', 'short' => 'Clear written proposal and remediation line items', 'description' => 'You receive a clear written proposal covering exactly what is included, how long it will take, and what it costs. For pre-war New Haven homes, we separately itemize any required remediation - lead abatement, knob-and-tube rewire, asbestos removal, steam pipe relocation - so you understand exactly where the budget is going.'],
                ...
                ['title' => 'Build', 'short' => 'Lead-safe demolition and daily updates', 'description' => 'Construction begins on the agreed schedule. In pre-war New Haven homes, we follow EPA RRP lead-safe work practices and maintain full containment during demolition. You receive daily updates on progress, a clean job site at the end of every workday, and crews who arrive when scheduled. If something unexpected comes up behind a wall, we contact you that day and present your options.'],
    ...
    [
        ...
        'data' => [
            ...
            'title' => 'Ready to Start Your Kitchen Remodel in New Haven?',
            'title_highlight' => 'New Haven',
...
ApiPageController::forgetCacheForPath('/kitchen-remodeling/new-haven-ct');
Artisan::call('optimize:clear');

$page = Page::query()
    ->where('full_path', '/kitchen-remodeling/new-haven-ct')
