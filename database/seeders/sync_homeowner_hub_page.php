...
$budgetingBlocks = [
    [
        'title' => 'Scope: Cosmetic vs. Structural',
        'content_html' => <<<'HTML'
...
HTML,
    ...
    [
        'title' => 'Labor Market in Connecticut',
        'content_html' => <<<'HTML'
...
HTML,
    ...
    [
        'title' => 'Age and Condition of Your Home',
        'content_html' => <<<'HTML'
...
HTML,
    ...
    [
        'title' => 'Geographic Variation Within Connecticut',
        'content_html' => <<<'HTML'
...
$accessibilityBlocks = [
    [
        'title' => 'Universal Design vs. Medical Retrofits',
        'content_html' => <<<'HTML'
...
HTML,
    ...
    [
        'title' => "Connecticut's Older Housing Stock",
        'content_html' => <<<'HTML'
...
HTML,
    ...
    [
        ...
        'content_html' => <<<'HTML'
The best answer is: before you need to. If you are already planning a <a href="/kitchen-remodeling/">kitchen</a> or <a href="/bathroom-remodeling/">bathroom</a> remodel, incorporating universal design features at that point costs a fraction of what it would cost to retrofit later. Adding blocking behind drywall for future grab bars during a bathroom renovation is nearly free. Widening a doorway during a room reconfiguration adds marginal cost. Installing a curbless shower instead of a tub-shower combo during a bathroom gut is a design choice, not an upcharge.</p><p>The expensive version is doing all of this work reactively, after a fall, after a diagnosis, after the need is urgent. Reactive work happens on compressed timelines with fewer design options and higher costs. Planning ahead gives you better outcomes at lower cost.
HTML,
    ],
];
...
$sections = [
    [
        'type' => 'hero',
        'data' => [
            'headline' => 'Homeowner Hub: Your Connecticut Remodeling Guide',
            'subheadline' => 'Practical information on planning, costs, permits, and how to evaluate a contractor so you go into your remodel informed.',
            'background_image' => '/hero/builtwell-team-van-consultation-hero-ct.jpg',
            'background_image_alt' => 'BuiltWell CT team arriving at a Connecticut home for a remodeling consultation',
            'overlay' => ['opacity' => 0.72],
            'badges' => [
                ['label' => 'Get Your Free Estimate', 'value' => null, 'url' => '#contact', 'is_primary' => true],
    ...
    [
        ...
        'data' => [
            ...
            'items' => [
                ...
                ['value' => null, 'label' => 'Fully Bonded & Insured'],
            ],
        ],
    ],
    [
        ...
        'data' => [
            ...
            'title' => 'What Every Connecticut Homeowner Should Know',
            'highlight_text' => 'Should Know',
            'content' => $overviewContent,
            'style_variant' => 'homeowner_hub_overview',
            'align' => 'center',
            'surface' => 'white',
            'container_width' => 'narrow',
            'tags' => ['Planning', 'Budgeting', 'Permits', 'Contractor', 'Aging in Place'],
        ],
    ],
    [
        'type' => 'rich_text',
        'data' => [
            ...
            'style_variant' => 'homeowner_hub_content',
            'surface' => 'light',
            'container_width' => 'narrow',
            'anchor_id' => 'planning',
    ...
    [
        ...
        'data' => [
            'eyebrow' => 'Budgeting',
            'title' => 'What Drives Remodeling Costs in Connecticut',
            'highlight_text' => 'Connecticut',
            'content' => $budgetingIntro,
            'style_variant' => 'homeowner_hub_content',
            'surface' => 'white',
            'container_width' => 'narrow',
            'anchor_id' => 'budgeting',
            'blocks' => $budgetingBlocks,
            'callout' => [
                'title' => 'How to Use This Information',
                'content_html' => 'Understanding what drives costs helps you have a more productive first conversation with any contractor. Instead of asking "how much does a kitchen cost," you can ask about your specific scope, your specific home, and your specific material preferences. That conversation leads to a real number - not a range pulled from a website. For detailed pricing by service type, visit our <a href="/services/">services page</a>.',
            ],
        ],
    ],
    [
        'type' => 'feature_grid',
        'data' => [
            'variant' => 'homeowner_hub_permits',
            'eyebrow' => 'Permits and Codes',
            'title' => 'Permits and Building Codes in Connecticut',
            'highlight_text' => 'Connecticut',
            'subtitle' => 'Connecticut requires building permits for any remodeling work involving structural changes, electrical, plumbing, or HVAC modifications, with separate permits often needed for each trade and inspections required at multiple stages.',
            'surface' => 'dark',
            ...
            'note_html' => 'We handle all permits for you. We prepare and submit all permit applications, account for review timelines, and manage every inspection. You do not need to interact with the building department.</p><p>Unpermitted work creates legal and financial risk. If you sell your home, a title search or buyer inspection can flag unpermitted improvements. The town can require you to remove or redo the work. Always verify that your contractor pulls the proper permits. <strong>Verify any contractor at the <a href="https://www.elicense.ct.gov/Lookup/LicenseLookup.aspx" target="_blank" rel="noopener noreferrer">CT DCP online license lookup</a>. Our license: CT HIC #0668405.</strong>',
        ],
    ],
    [
        'type' => 'feature_grid',
        'data' => [
            'variant' => 'homeowner_hub_checklist',
            'eyebrow' => 'Contractor Checklist',
            'title' => 'How to Choose a Remodeling Contractor',
            'highlight_text' => 'Contractor',
            'subtitle' => 'Choosing a Connecticut remodeling contractor requires verifying their CT HIC license at the Department of Consumer Protection, confirming general liability and workers comp insurance, and reviewing a written line-item proposal before signing any agreement.',
            'surface' => 'light',
            'anchor_id' => 'contractor',
            'items' => [
                ['step_number' => 1, 'title' => 'Verify CT HIC License', 'description' => 'Ask for the number. Look it up at CT Department of Consumer Protection. A current license means traceable legal identity and state requirements met.'],
                ['step_number' => 2, 'title' => 'Confirm Insurance', 'description' => 'Ask for general liability and workers comp certificates. If a worker is injured and the contractor has no workers comp, you can be exposed to a liability claim.'],
                ['step_number' => 3, 'title' => 'Written Line-Item Proposal', 'description' => 'A single number is not a proposal. A real proposal describes full scope, timeline, permits, payment schedule. Vague language becomes disagreements later.'],
                ['step_number' => 4, 'title' => 'Check Reviews', 'description' => 'Look at volume and recency, not just star rating. Read the 1 and 2 star reviews. Pay attention to how the contractor responds to negative reviews.'],
                ['step_number' => 5, 'title' => 'Ask About Communication', 'description' => 'Who is your point of contact? How often will you hear from them? How are change orders handled? Daily updates should be the standard.'],
                ['step_number' => 6, 'title' => 'Understand Payment Terms', 'description' => 'Be cautious of anyone asking more than 30-40% upfront or final payment before the walkthrough is complete.'],
                ['step_number' => 7, 'title' => 'Ask Who Does the Work', 'description' => 'Some companies subcontract everything. Others maintain consistent crews. Consistent crews produce more consistent work.'],
            ],
        ],
    ],
    [
        ...
        'data' => [
            ...
            'title' => 'Aging in Place Remodeling in Connecticut',
            'highlight_text' => 'Connecticut',
            'style_variant' => 'homeowner_hub_accessibility',
            'surface' => 'white',
            'container_width' => 'narrow',
            'anchor_id' => 'accessibility',
            'intro_paragraphs' => $accessibilityIntro,
            'blocks' => $accessibilityBlocks,
            'image' => '/images/headers/comfort-accessibility-header.jpg',
            'image_alt' => 'Accessible home remodeling in Connecticut with curbless shower, wider doorways, and universal design by BuiltWell CT',
            'callout' => [
                'title' => 'Getting Started',
                'content_html' => 'If you are considering aging in place modifications - whether as part of a larger remodel or as a standalone project - the first step is an in-home assessment. We walk through your home, identify the highest-impact modifications for your situation, and provide a clear scope and cost. No charge, no obligation. <a href="/contact/">Schedule a free consultation</a> or call us directly.',
            ],
        ],
    ],
    [
        'type' => 'feature_grid',
        'data' => [
            'variant' => 'homeowner_hub_room_cards',
            'eyebrow' => 'Accessibility by Space',
            'title' => 'Room-by-Room: Where It Matters Most',
            'highlight_text' => 'Where It Matters Most',
            'surface' => 'white',
            'items' => [
                [
                    'title' => 'Bathrooms',
                ...
                [
                    'title' => 'Stairs and Floor Transitions',
                    'bullets' => [
    ...
    [
        'type' => 'feature_grid',
        'data' => [
            'variant' => 'homeowner_hub_funding_cards',
            'eyebrow' => 'Funding and Assistance',
            'title' => 'Connecticut Programs for Accessibility Modifications',
            'highlight_text' => 'Accessibility',
            'subtitle' => 'Connecticut homeowners can access six funding sources for accessibility modifications, including the CT Home Care Program, USDA Section 504 grants up to $10,000, VA housing grants, and IRS medical expense deductions for prescribed modifications.',
            'surface' => 'dark',
            'background_image' => '/hero/builtwell-job-site-aerial-hero-ct.jpg',
            'items' => [
                ['title' => 'CT Home Care Program', 'description' => 'Administered by the CT Department of Social Services, this Medicaid waiver program covers home modifications for eligible seniors and adults with disabilities - including ramps, grab bars, and bathroom modifications.', 'url' => 'https://portal.ct.gov/dss/health-and-home-care/connecticut-home-care-program-for-elders/connecticut-home-care-program-for-elders-chcpe'],
                ['title' => 'USDA Section 504 Grants', 'description' => 'Available to very-low-income homeowners age 62 and older. Grants up to $10,000 for removing health and safety hazards, including accessibility modifications. Available in qualifying CT areas.', 'url' => 'https://www.rd.usda.gov/programs-services/single-family-housing-programs/single-family-housing-repair-loans-grants'],
                ['title' => 'VA SAH / SHA Grants', 'description' => 'Veterans with service-connected disabilities may qualify for Specially Adapted Housing (SAH) or Special Housing Adaptation (SHA) grants - covering wheelchair ramps, roll-in showers, widened doorways, and more.', 'url' => 'https://www.va.gov/housing-assistance/disability-housing-grants/'],
                ['title' => 'Area Agencies on Aging', 'description' => "Connecticut's five Area Agencies on Aging administer local programs for home modification assistance. Coverage and eligibility vary by region. Contact your local AAA for current availability.", 'url' => 'https://portal.ct.gov/aginganddisability/content-pages/topics-a-z/area-agencies-on-aging'],
                ['title' => 'Medical Expense Deduction', 'description' => 'Home modifications prescribed by a physician as medically necessary may qualify as deductible medical expenses on federal taxes. Consult your tax advisor for eligibility and documentation requirements.', 'url' => 'https://www.irs.gov/taxtopics/tc502'],
                ['title' => 'GreenSky Financing', 'description' => 'For homeowners who do not qualify for assistance programs, we offer flexible financing through GreenSky. Get approved in about 60 seconds with competitive rates and manageable monthly payments. The Energize CT program, administered by Eversource and United Illuminating, offers rebates on insulation, HVAC, and appliance upgrades for Connecticut homeowners.', 'url' => 'https://www.greensky.com/'],
            ],
        ],
    ],
    [
        ...
        'data' => [
            ...
            'highlight_text' => 'Service Areas',
            'subtitle' => 'We serve 16 towns across Fairfield County and New Haven County with dedicated local crews, covering every community from Greenwich to Madison and headquartered in Orange, CT.',
            'counties' => [
                [
    ...
    [
        'type' => 'feature_grid',
        'data' => [
            'variant' => 'homeowner_hub_resources',
            'eyebrow' => 'Additional Resources',
            'title' => 'Learn More',
            'highlight_text' => 'More',
            'surface' => 'light',
            'items' => [
                ['title' => 'Our Process', 'description' => 'Five clear steps from consultation to walkthrough.', 'url' => '/process/', 'icon' => 'list'],
                ['title' => 'FAQ', 'description' => 'Answers to the most common remodeling questions.', 'url' => '/faq/', 'icon' => 'help-circle'],
                ['title' => 'Reviews', 'description' => 'What our clients say about working with BuiltWell.', 'url' => '/reviews/', 'icon' => 'star'],
                ['title' => 'About Us', 'description' => 'Our team, our standards, and why we do this.', 'url' => '/about/', 'icon' => 'users'],
                ['title' => 'Case Studies', 'description' => 'Real projects with scope, timeline, and results.', 'url' => '/case-studies/', 'icon' => 'briefcase'],
            ],
        ],
    ],
    [
        ...
        'data' => [
            ...
            'subtitle' => 'On-site or remote (Google Meet or Zoom). Tell us about your project. We respond within one business day. No obligation.',
            'subtitle2' => 'Fairfield County: (203) 919-9616 | New Haven County: (203) 466-9148',
            'images' => [
            ...
            'consent_text' => "We'll send a confirmation to your email within 24 hours.",
        ],
    ],
    [
        'type' => 'trust_bar',
...
DB::transaction(function () use ($sections): void {
    $page = Page::query()->firstOrNew(['full_path' => '/homeowner-hub']);
    $page->template_key = 'generic';
    $page->status = 'published';
    $page->published_at = $page->published_at ?? now();
    $page->seo_title = 'Homeowner Hub - CT Remodeling Guide | BuiltWell CT';
    $page->seo_description = 'Connecticut homeowner remodeling guide - costs, permits, contractor selection, and aging-in-place advice. Your complete resource from BuiltWell CT.';
    $page->canonical_url = 'https://buildwellct.com/homeowner-hub/';
    $page->save();
...
ApiPageController::forgetCacheForPath('/homeowner-hub');
Artisan::call('optimize:clear');

$page = Page::query()
    ->where('full_path', '/homeowner-hub')
