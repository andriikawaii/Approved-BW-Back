...
$pagePayload = [
    'full_path' => '/fairfield-county/westport-ct',
    'template_key' => 'service_town',
    'status' => 'published',
    'published_at' => now(),
    'seo_title' => 'Home Remodeling Westport, CT | BuiltWell CT',
    'seo_description' => 'Kitchen, bathroom, basement, and flooring remodeling in Westport, CT. Licensed Fairfield County contractor. CT HIC #0668405. Request a free consultation today.',
    'canonical_url' => 'https://buildwellct.com/fairfield-county/westport-ct/',
    'og_image_alt' => 'BuiltWell CT home remodeling contractor serving Westport, Connecticut',
    'robots' => 'index, follow',
];
...
$sections = [
    ...
    [
        'type' => 'hero',
        'data' => [
            'headline' => 'Home Remodeling in Westport, CT',
            'subheadline' => 'Home remodeling in Westport, CT including kitchens, bathrooms, basements, and additions. Licensed Fairfield County contractor serving Westport homeowners from our Orange office.',
            'background_image' => '/images/areas/westport-ct-downtown.jpg',
            'background_image_alt' => 'Downtown Westport, Connecticut aerial view',
            'overlay' => ['opacity' => 0.45],
            'cta_primary' => ['label' => 'Get Your Free Estimate', 'url' => '#contact'],
            'cta_secondary' => ['label' => 'Call (203) 919-9616', 'url' => 'tel:2039199616'],
            'badges' => [],
        ],
    ],
    ...
    [
        ...
        'data' => [
            ...
            'items' => [
                ...
                ['label' => 'Google Rating', 'value' => '4.9', 'icon' => 'star', 'url' => 'https://www.google.com/maps/search/?api=1&query=BuiltWell+CT,+206A+Boston+Post+Road,+Orange,+CT+06477'],
    ...
    [
        ...
        'data' => $rich(
            'Investment',
            'What Remodeling Costs in Westport, CT',
            ...
            ['highlight_text' => 'Westport, CT', 'anchor_id' => 'westport-costs-intro', 'container_width' => 'wide']
        ),
    ],
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Kitchen Remodeling Costs in Westport, CT',
            'subtitle' => 'Custom cabinetry alone in this market commonly runs $50,000 to $70,000. Subcontractors who work in this market regularly understand close-tolerance finish work, and their pricing reflects it.',
            'columns' => ['Tier', 'Scope', 'Typical Range'],
            'rows' => [
                ['label' => 'Minor Refresh', 'notes' => 'Countertops, appliances, cabinet fronts', 'price' => '$40,000 - $80,000'],
                ['label' => 'Mid-Range Gut', 'notes' => 'New cabinets, counters, flooring, appliances', 'price' => '$80,000 - $140,000'],
                ['label' => 'High-End', 'notes' => 'Custom cabinetry, structural changes, imported stone', 'price' => '$140,000 - $250,000+'],
            ],
        ],
    ],
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Bathroom Remodeling Costs in Westport, CT',
            'columns' => ['Tier', 'Scope', 'Typical Range'],
            'rows' => [
                ['label' => 'Hall Bath Update', 'notes' => 'New vanity, toilet, tile, fixtures', 'price' => '$25,000 - $45,000'],
                ['label' => 'Primary Suite Gut', 'notes' => 'Full gut, walk-in shower, double vanity', 'price' => '$45,000 - $65,000'],
                ['label' => 'Full Custom Primary', 'notes' => 'Walk-in shower, heated floors, specialty tile', 'price' => '$80,000 - $120,000+'],
            ],
        ],
    ],
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Basement Finishing Costs in Westport, CT',
            'subtitle' => 'For homes in or near flood zones, we address drainage and moisture management before framing begins. That work adds to overall project cost but is not optional if you want a finished basement that holds up.',
            'columns' => ['Tier', 'Scope', 'Typical Range'],
            'rows' => [
                ['label' => 'Basic', 'notes' => 'Framing, drywall, basic flooring, lighting', 'price' => '$25,000 - $45,000'],
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Flooring Costs in Westport, CT',
            'subtitle' => "Many 1960s Westport colonials have original hardwood floors under carpet or vinyl that are worth refinishing. We assess what is there and give you a straight answer on whether to refinish or replace.",
    ...
    // ── 15. ADDITIONS PRICING ────────────────────────────────────
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Home Additions Costs in Westport, CT',
            'subtitle' => 'Westport additions in coastal and flood zone areas may require elevation to Base Flood Elevation, adding to project scope and cost.',
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Interior Painting Costs in Westport, CT',
    ...
    // ── 17. CARPENTRY PRICING ────────────────────────────────────
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Interior Carpentry Costs in Westport, CT',
            'subtitle' => "Postwar Westport colonials and Cape Cods often have original trim profiles and built-in cabinetry that homeowners want preserved or matched during renovation. Custom millwork to replicate these details adds both material cost and lead time compared to standard stock profiles.",
            'columns' => ['Scope', 'Details', 'Typical Range'],
            'rows' => [
    ...
    // ── 18. ADDITIONAL SERVICES PRICING ──────────────────────────
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Additional Service Costs in Westport, CT',
    ...
    [
        ...
        'data' => $rich(
            ...
            "Westport's permit fee is \$10 per \$1,000 of renovation budget, which is straightforward but adds up on higher-budget projects. Flood zone compliance, when it applies, adds engineering and material costs that are not present in drier towns. Ledge rock in Coleytown and other interior neighborhoods creates excavation contingencies that less experienced contractors either miss or do not disclose. And the subcontractor network that works at the finish level Westport homeowners expect charges accordingly. Bringing in tradespeople who are not calibrated to this market tends to show. We do not do it.",
            ['anchor_id' => 'westport-cost-drivers', 'container_width' => 'wide']
        ),
    ],
    ...
    [
        ...
        'data' => [
            ...
            'title' => 'Our Remodeling Services in Westport, CT',
            'highlight_text' => 'Westport, CT',
            'subtitle' => "BuiltWell CT provides a full range of remodeling services in Westport including kitchen renovation, bathroom remodeling, basement finishing, flooring, home additions, interior painting, carpentry, attic conversions, decks, design, and accessibility modifications, all permitted and backed by CT HIC License #0668405. Westport's 1940s-1970s colonials, coastal properties, and flood zone considerations shape how we approach every project.",
            'initial_visible_count' => 6,
            'toggle_label' => 'Show 6 More Services',
            'toggle_less_label' => 'Show Fewer Services',
            'surface' => 'cream',
            'items' => [
                ['title' => 'Kitchen Remodeling in Westport, CT', 'summary' => 'Full kitchen renovations in Westport including cabinetry, countertops, tile, electrical, plumbing, and permits. Custom cabinet lead times run 8 to 12 weeks in this market.', 'image' => '/services/kitchen-remodeling-ct.jpg', 'image_alt' => 'Kitchen remodeling in Westport CT by BuiltWell Fairfield County team', 'url' => '/kitchen-remodeling/westport-ct/', 'cta_label' => 'Get Started', 'price' => '$40K-$250K+', 'timeline' => '6-12 weeks'],
                ['title' => 'Bathroom Remodeling in Westport, CT', 'summary' => 'Primary suite renovations, hall bath updates, and full gut remodels. Our Westport bathroom case study shows our approach in detail.', 'image' => '/services/bathroom-remodeling-ct.jpg', 'image_alt' => 'Bathroom remodeling in Westport CT by BuiltWell Fairfield County team', 'url' => '/bathroom-remodeling/westport-ct/', 'cta_label' => 'Get Started', 'price' => '$25K-$120K+', 'timeline' => '3-6 weeks'],
                ['title' => 'Basement Finishing in Westport, CT', 'summary' => 'Flood zone awareness before anything else. In Westport, we confirm existing floor elevation relative to Base Flood Elevation before framing begins.', 'image' => '/services/basement-finishing-ct.jpg', 'image_alt' => 'Basement finishing in Westport CT by BuiltWell Fairfield County team', 'url' => '/basement-finishing/westport-ct/', 'cta_label' => 'Get Started', 'price' => '$25K-$100K+', 'timeline' => '4-8 weeks'],
                ['title' => 'Flooring in Westport, CT', 'summary' => "Hardwood, LVP, tile, and engineered wood. Original hardwood in Westport's 1950s colonials is often intact under carpet and worth refinishing.", 'image' => '/services/flooring-hardwood-installation-ct-02.jpg', 'image_alt' => 'Flooring installation in Westport CT by BuiltWell Fairfield County team', 'url' => '/flooring/westport-ct/', 'cta_label' => 'Get Started', 'price' => '$6-$25/sq ft', 'timeline' => '2-5 days'],
                ['title' => 'Home Additions in Westport, CT', 'summary' => 'Single-story and second-story additions, sunrooms, and bump-outs with full structural work for Westport homeowners.', 'image' => '/services/home-additions-ct.jpg', 'image_alt' => 'Home additions in Westport CT by BuiltWell Fairfield County team', 'url' => '/home-additions/', 'cta_label' => 'Get Started', 'price' => '$150-$400/sq ft', 'timeline' => '8-16 weeks'],
                ['title' => 'Interior Painting in Westport, CT', 'summary' => 'Walls, ceilings, trim, doors, and built-ins with professional-grade paints and proper prep for Westport homes.', 'image' => '/services/interior-painting-ct.jpg', 'image_alt' => 'Interior painting in Westport CT by BuiltWell Fairfield County team', 'url' => '/interior-painting/', 'cta_label' => 'Get Started', 'price' => '$3-$6/sq ft', 'timeline' => '2-5 days'],
                ['title' => 'Interior Carpentry in Westport, CT', 'summary' => 'Custom millwork, built-in cabinetry, wainscoting, crown molding, coffered ceilings, closet systems, and finish trim for Westport residences.', 'image' => '/portfolio/builtwell-team-completed-interior-ct.png', 'image_alt' => 'Interior carpentry and custom millwork in Westport CT by BuiltWell', 'url' => '/interior-carpentry/', 'cta_label' => 'Get Started', 'price' => '$75-$150/hr', 'timeline' => 'Varies'],
                ['title' => 'Attic Conversions in Westport, CT', 'summary' => 'Converting unfinished attics into bedrooms, offices, or playrooms with full structural assessment in Westport.', 'image' => '/portfolio/builtwell-team-interior-inspection-ct.jpg', 'image_alt' => 'Attic conversion remodeling in Westport CT by BuiltWell', 'url' => '/attic-conversions/', 'cta_label' => 'Get Started', 'price' => '$50K-$150K', 'timeline' => '6-12 weeks'],
                ['title' => 'Decks and Porches in Westport, CT', 'summary' => 'Pressure-treated lumber, composite, and hardwood. Covered porches, screened-in structures, pergolas, and multi-level decks built for Westport properties.', 'image' => '/portfolio/home-remodeling-contractor-tour-ct.png', 'image_alt' => 'Deck and porch construction in Westport CT by BuiltWell', 'url' => '/decks-porches/', 'cta_label' => 'Get Started', 'price' => '$15K-$75K', 'timeline' => '2-4 weeks'],
                ['title' => 'Design and Planning in Westport, CT', 'summary' => 'Space planning, material selection, finish coordination, and project documentation before construction begins on your Westport remodel.', 'image' => '/services/design-planning-project-ct.jpg', 'image_alt' => 'Remodeling design and planning in Westport CT by BuiltWell', 'url' => '/remodeling-design-planning/', 'cta_label' => 'Get Started', 'price' => '$2.5K-$15K', 'timeline' => '2-6 weeks'],
                ['title' => 'Comfort and Accessibility in Westport, CT', 'summary' => 'Grab bars, roll-in showers, wider doorways, ramp installation, and first-floor adaptations for Westport homeowners of all ages and abilities.', 'image' => '/portfolio/builtwell-team-contractors-ct-01.jpg', 'image_alt' => 'Comfort and accessibility remodeling in Westport CT by BuiltWell', 'url' => '/comfort-accessibility-remodeling/', 'cta_label' => 'Get Started', 'price' => '$5K-$50K', 'timeline' => '1-4 weeks'],
                ['title' => 'Insurance Reconstruction in Westport, CT', 'summary' => 'Rebuilding Westport homes after fire, water, and storm damage. Full reconstruction once cleanup is complete, working directly with your insurance carrier.', 'image' => '/portfolio/builtwell-contractor-handshake-arrival-ct-optimized.jpg', 'image_alt' => 'Insurance reconstruction contractor in Westport CT by BuiltWell', 'url' => '/insurance-restoration/', 'cta_label' => 'Get Started', 'price' => '$25K-$250K+', 'timeline' => '4-16 weeks'],
            ],
        ],
    ],
    ...
    [
        'type' => 'cta_block',
        'data' => [
            'title' => 'Ready to Remodel in Westport?',
            'subtitle' => "From Compo Beach colonials to Greens Farms estates \u{2014} Westport remodeling that respects the character of your home.",
    ...
    [
        ...
        'data' => [
            ...
            'title' => 'Frequently Asked Questions: Westport Remodeling',
            'highlight_text' => 'Westport Remodeling',
            'subtitle' => "Westport homeowners most commonly ask about permit requirements, remodeling costs, flood zone impact, project timelines, and what makes renovation in 1960s colonials different from newer construction.",
            'items' => [
                ['question' => 'Do I need a permit for kitchen remodeling in Westport, CT?', 'answer' => "Yes. Nearly all interior remodeling work in Westport requires a building permit, including kitchen renovations, wall removals, electrical upgrades, and plumbing modifications. Westport's code takes a default-permit approach: it lists only the work that does not require a permit, which means almost everything requires one. The building permit fee is \$10 per \$1,000 of renovation budget. We pull all permits as part of every project we take on; it is not optional and we do not treat it as one. Contact the Westport Building Department at 203-341-5025 for permit-specific questions."],
                ['question' => 'How much does a kitchen remodel cost in Westport?', 'answer' => "Kitchen remodeling in Westport typically starts at \$40,000 for a minor refresh (countertops, appliances, cabinet fronts) and runs to \$80,000 for that scope done well. A mid-range gut renovation with new cabinets, countertops, flooring, and appliances runs \$80,000 to \$140,000. High-end projects involving custom cabinetry, structural changes, and imported stone run \$140,000 to \$250,000 and higher. Custom cabinetry alone commonly runs \$50,000 to \$70,000 in this market. Several factors push costs above the range that applies in lower-cost Connecticut towns: the permit fee, the expectation level for finish work and materials, and the subcontractor network that is calibrated to work at this level. We can discuss your specific kitchen, layout, and goals in a free consultation. Call (203) 919-9616."],
                ['question' => 'Does my Westport home\'s flood zone affect a renovation project?', 'answer' => "Yes, if your home falls within FEMA's Special Flood Hazard Area. In AE flood zones, which cover most of Westport's developed floodplain areas including parts of Compo, Saugatuck, and Saugatuck Shores, the lowest floor of a new or substantially improved structure must be elevated to or above Base Flood Elevation. The \"substantially improved\" rule is the one that most often catches homeowners off guard: if your renovation cost exceeds 50 percent of the pre-improvement market value of the structure, the entire project must meet current flood zone compliance requirements, including elevation. On older beach cottages with a low structure value relative to land value, that threshold is reachable on a renovation that the homeowner thinks of as moderate in scope. We check flood map status for every Westport project before scope and pricing discussions begin. For projects in coastal Westport (Compo, Saugatuck Shores, and Greens Farms waterfront areas), CT DEEP Coastal Area Management review may also be required under the Connecticut Coastal Management Act."],
                ['question' => 'How long does a bathroom remodel take in Westport?', 'answer' => "A typical bathroom remodel in Westport takes 3 to 6 weeks of active construction once permits are in hand and materials are on-site. A straightforward hall bath update (new vanity, toilet, tile, and fixtures without moving plumbing) falls toward the shorter end. A fully gutted primary suite with a walk-in shower, double vanity, heated floor, specialty tile, and reconfigured plumbing runs 6 to 8 weeks. The most common source of schedule extension in older Westport homes is what we find inside the walls after demolition: original plumbing supply lines, deteriorated drain stacks, or electrical wiring that needs replacement before finish work can begin. We communicate directly and immediately when we encounter those conditions, and we address them as part of the project rather than around it."],
                ['question' => 'Is my 1960s colonial in Coleytown or Saugatuck harder to remodel than a newer home?', 'answer' => "Yes, in specific and predictable ways that we account for before a project starts. Homes built in the 1950s through 1970s in Westport frequently have original electrical panels, often 100-amp single-panel systems that are not adequate for modern kitchen or bathroom loads and need upgrading when a remodel opens the walls. Floor tiles from before 1980 may contain asbestos, which requires proper testing and abatement before any demolition proceeds. Basement moisture in homes of this era tends to be a product of aging foundation drainage and original waterproofing that was never designed for finished habitable space. We assess that before framing. In Coleytown specifically, ledge rock conditions mean that any project breaking ground (a pool, an addition, a new foundation section) may encounter solid ledge that requires blasting or pneumatic hammer excavation. We flag that contingency in the proposal. None of these challenges make a project impossible. They make experience, honesty, and scope accuracy matter more."],
                ['question' => 'How does insurance reconstruction work after storm damage in Westport, CT?', 'answer' => "Insurance reconstruction after storm damage in Westport starts with filing your claim and having an adjuster assess the damage to your property. We then work directly with your insurance carrier to document the full scope of damage, agree on pricing, and manage the rebuild from start to finish. Westport's coastal exposure means storm damage claims are common, particularly in Compo, Saugatuck Shores, and Greens Farms. We coordinate with carriers including State Farm, Liberty Mutual, Travelers, and USAA. We handle all supplemental documentation when the initial adjuster estimate does not cover the full scope of required work, which is common on storm damage projects where hidden moisture or structural damage becomes visible only after demo begins. You do not need to manage payments between us and your carrier. We bill the insurance company directly and handle all inspection coordination. Reconstruction timelines vary from 6 weeks for contained water damage to 4 to 6 months for major structural storm damage. We hold CT HIC License #0668405."],
                ['question' => 'Does a kitchen remodel increase home value in Westport, CT?', 'answer' => "Yes, a kitchen remodel is one of the highest-ROI improvements you can make to a Westport home, typically returning 60% to 80% of the investment at resale. In Westport's market, where median home values are well above the state average, buyers expect updated kitchens with quality finishes. A mid-range kitchen renovation in the \$80,000 to \$140,000 range brings the most consistent return because it brings the kitchen up to current buyer expectations without over-improving relative to the neighborhood. High-end custom kitchens at \$200,000 and above also add significant value in neighborhoods like Greens Farms and Long Lots where comparable sales support that level of finish. Beyond resale value, a kitchen remodel eliminates the most common objection buyers raise when evaluating a home, which is the condition of the kitchen."],
            ],
        ],
    ],
    ...
    [
        ...
        'data' => [
            ...
            'counties' => [[
                ...
                'town_links' => ['Greenwich' => '/fairfield-county/greenwich-ct/'],
                'current_town' => 'Westport',
    ...
    [
        ...
        'data' => [
            ...
            'images' => [
                ['image' => '/team/builtwell-owner-handshake-client-ct-02.jpg', 'alt' => 'BuiltWell CT meeting with a Westport homeowner for a remodeling consultation'],
    ...
    [
        'type' => 'rich_text',
        'data' => $rich('', 'Flexible Financing Available', 'Get approved in about 60 seconds and start your project today.', ['cta' => ['label' => 'Check Financing Options', 'url' => '/financing/'], 'style_variant' => 'financing_strip', 'spacing' => 'compact']),
    ],
];
...
ApiPageController::forgetCacheForPath('/fairfield-county/westport-ct');
Artisan::call('optimize:clear');

$page = Page::query()->where('full_path', '/fairfield-county/westport-ct')->with(['sections' => fn ($query) => $query->orderBy('sort_order')])->firstOrFail();
echo json_encode(['page_id' => $page->id, 'full_path' => $page->full_path, 'template_key' => $page->template_key, 'section_types' => $page->sections->pluck('type')->all(), 'section_count' => $page->sections->count()], JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES), PHP_EOL;
