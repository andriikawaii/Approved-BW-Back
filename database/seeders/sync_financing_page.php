...
$sections = [
    [
        'type' => 'hero',
        'data' => [
            'headline' => 'Financing Your Connecticut Remodeling Project',
            'highlight_text' => 'Remodeling Project',
            'subheadline' => 'Understanding your financing options before the estimate arrives puts you in a better position to make decisions that work for your household and helps us right-size the project scope to match what you want to spend.',
            'background_image' => '/portfolio/builtwell-contractor-handshake-arrival-ct-optimized.jpg',
        ...
        'data' => [
            ...
            'fields' => [
                ...
                [
                    ...
                    'type' => 'textarea',
                    'required' => false,
                    'placeholder' => 'Tell us about your project, what rooms, what changes, any timeline or budget considerations...',
                ],
            ],
...
\Illuminate\Support\Facades\DB::transaction(function () use ($sections): void {
    $page = \App\Models\Page::query()->whereIn('full_path', ['/financing', '/financing/'])->first();
    if (!$page) {
        $page = new \App\Models\Page();
    }

    $page->full_path = '/financing';
    ...
    foreach ($sections as $index => $sectionPayload) {
        \App\Models\Section::query()->create([
            'page_id' => $page->id,
...
\App\Http\Controllers\Api\PageController::forgetCacheForPath('/financing');
\Illuminate\Support\Facades\Artisan::call('optimize:clear');

$page = \App\Models\Page::query()
    ->where('full_path', '/financing')
