...
$pagePayload = [
    'full_path' => '/new-haven-county/madison-ct',
    'template_key' => 'service_town',
    'status' => 'published',
    'published_at' => now(),
    'seo_title' => 'Home Remodeling Madison, CT | BuiltWell CT',
    'seo_description' => 'Home remodeling in Madison, CT - kitchens, bathrooms, basements, and flooring by a licensed New Haven County contractor. Schedule a free estimate.',
    'canonical_url' => 'https://buildwellct.com/new-haven-county/madison-ct/',
    'og_image_alt' => 'BuiltWell CT home remodeling contractor serving Madison, Connecticut',
    'robots' => 'index, follow',
];
...
$sections = [
    [
        'type' => 'hero',
        'data' => [
            'headline' => 'Home Remodeling in Madison, CT',
            'subheadline' => 'Home remodeling in Madison, CT from shoreline kitchens to full renovations. Licensed New Haven County contractor with experience building for coastal Connecticut conditions.',
            'background_image' => '/images/areas/madison-ct-town.jpg',
            'background_image_alt' => 'Aerial view of Madison, Connecticut shoreline',
    ...
    [
        ...
        'data' => [
            'title' => 'Madison Homes and What They Require',
            'subtitle' => "Madison's housing stock reflects its identity as a Connecticut shoreline town, with beach cottages from the early 1900s, mid-century colonials throughout the inland neighborhoods, and newer construction from the 1990s and 2000s. The coastal environment creates specific material and moisture challenges that affect every renovation project in town.",
            'alignment' => 'center',
        ],
    ],
    [
    ...
    [
        ...
        'data' => $rich(
            'Investment',
            'What Remodeling Costs in Madison, CT',
            ...
            ['highlight_text' => 'Madison, CT', 'anchor_id' => 'madison-costs-intro', 'container_width' => 'wide']
        ),
    ],
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Kitchen Remodeling Costs in Madison, CT',
            'subtitle' => "Coastal material premium: Madison's shoreline location means kitchen renovations typically require moisture-resistant materials, marine-grade hardware, and enhanced ventilation systems that add 10 to 15 percent to material costs compared to inland towns.",
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Bathroom Remodeling Costs in Madison, CT',
            'columns' => ['Tier', 'Scope', 'Typical Range'],
            'rows' => [
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Basement Finishing Costs in Madison, CT',
            'subtitle' => 'Coastal moisture is a significant factor in Madison basements. Proper waterproofing assessment and vapor barrier installation should be completed before any finish work begins in below-grade spaces.',
            'columns' => ['Tier', 'Scope', 'Typical Range'],
            'rows' => [
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Flooring Costs in Madison, CT',
            'subtitle' => "Madison's elevated humidity makes engineered hardwood and luxury vinyl plank strong choices for ground-level and below-grade installations. Solid hardwood performs well on upper floors where moisture exposure is lower.",
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Home Additions Costs in Madison, CT',
            'subtitle' => 'Additions in Madison often focus on expanding living space toward outdoor views or adding sunrooms and screened porches that connect the home to the shoreline setting.',
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Interior Painting Costs in Madison, CT',
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Interior Carpentry Costs in Madison, CT',
            'subtitle' => "Madison homes often feature custom built-ins, window seats with Sound views, and detailed trim work that reflects the town's architectural character.",
            'columns' => ['Scope', 'Details', 'Typical Range'],
            'rows' => [
    ...
    [
        'type' => 'pricing_table',
        'data' => [
            'title' => 'Additional Service Costs in Madison, CT',
    ...
    [
        ...
        'data' => $rich(
            ...
            ['anchor_id' => 'madison-cost-drivers', 'container_width' => 'wide']
        ),
    ],
    [
        'type' => 'services_grid',
        'data' => [
            ...
            'title' => 'Our Remodeling Services in Madison, CT',
            'highlight_text' => 'Madison, CT',
            'subtitle' => "BuiltWell CT provides a full range of remodeling services in Madison including kitchen renovation, bathroom remodeling, basement finishing, flooring, home additions, interior painting, carpentry, attic conversions, decks, design, and accessibility modifications. Madison's shoreline location and coastal housing stock shape how we plan and build every project.",
            'initial_visible_count' => 6,
            'toggle_label' => 'Show 6 More Services',
            'toggle_less_label' => 'Show Less',
            'items' => [
                ['title' => 'Kitchen Remodeling in Madison, CT', 'summary' => 'Full kitchen renovations for Madison homes, from beach cottage updates to larger shoreline properties with open layouts designed around coastal views and entertaining.', 'image' => '/services/kitchen-remodeling-ct.jpg', 'image_alt' => 'Kitchen remodeling in Madison CT by BuiltWell from our Orange office', 'url' => '/kitchen-remodeling/madison-ct/', 'cta_label' => 'Get Started', 'price' => '$25K-$150K+', 'timeline' => '6-12 weeks'],
                ['title' => 'Bathroom Remodeling in Madison, CT', 'summary' => 'Complete bathroom renovations in Madison with moisture-resistant materials selected for coastal humidity, including tile, vanities, showers, and ventilation upgrades.', 'image' => '/services/bathroom-remodeling-ct.jpg', 'image_alt' => 'Bathroom remodeling in Madison CT by BuiltWell from our Orange office', 'url' => '/bathroom-remodeling/madison-ct/', 'cta_label' => 'Get Started', 'price' => '$15K-$80K+', 'timeline' => '3-6 weeks'],
                ['title' => 'Basement Finishing in Madison, CT', 'summary' => 'Converting unfinished basements into usable living space in Madison with proper coastal moisture management, waterproofing, and humidity-rated materials.', 'image' => '/services/basement-finishing-ct.jpg', 'image_alt' => 'Basement finishing in Madison CT by BuiltWell from our Orange office', 'url' => '/basement-finishing/madison-ct/', 'cta_label' => 'Get Started', 'price' => '$25K-$100K+', 'timeline' => '4-8 weeks'],
                ['title' => 'Flooring in Madison, CT', 'summary' => "Hardwood, LVP, tile, and engineered wood for Madison homes. We recommend moisture-appropriate materials based on each room's proximity to the coast and grade level.", 'image' => '/services/flooring-installation-ct.jpg', 'image_alt' => 'Flooring installation in Madison CT by BuiltWell from our Orange office', 'url' => '/flooring/madison-ct/', 'cta_label' => 'Get Started', 'price' => '$6-$25/sq ft', 'timeline' => '2-5 days'],
                ['title' => 'Home Additions in Madison, CT', 'summary' => 'Single-story and second-story additions, sunrooms, and bump-outs for Madison properties, including coastal-rated structural work and weather-resistant exteriors.', 'image' => '/services/home-additions-ct.jpg', 'image_alt' => 'Home additions in Madison CT by BuiltWell from our Orange office', 'url' => '/home-additions/', 'cta_label' => 'Get Started', 'price' => '$150-$400/sq ft', 'timeline' => '8-16 weeks'],
                ['title' => 'Interior Painting in Madison, CT', 'summary' => 'Walls, ceilings, trim, doors, and built-ins with professional-grade paints and proper prep for Madison homes, including moisture-resistant primers for coastal properties.', 'image' => '/services/interior-painting-ct.jpg', 'image_alt' => 'Interior painting in Madison CT by BuiltWell from our Orange office', 'url' => '/interior-painting/', 'cta_label' => 'Get Started', 'price' => '$3-$6/sq ft', 'timeline' => '2-5 days'],
                ['title' => 'Interior Carpentry in Madison, CT', 'summary' => 'Custom millwork, built-in cabinetry, wainscoting, crown molding, coffered ceilings, and finish trim for Madison residences, including window seats with shoreline views.', 'image' => '/services/interior-carpentry-ct.jpg', 'image_alt' => 'Interior carpentry in Madison CT by BuiltWell', 'url' => '/interior-carpentry/', 'cta_label' => 'Get Started', 'price' => '$75-$150/hr', 'timeline' => 'Varies'],
                ['title' => 'Attic Conversions in Madison, CT', 'summary' => 'Converting unfinished attics in Madison into bedrooms, offices, or playrooms with proper insulation rated for coastal climate conditions and structural assessment.', 'image' => '/services/attic-conversions-ct.jpg', 'image_alt' => 'Attic conversion remodeling in Madison CT by BuiltWell', 'url' => '/attic-conversions/', 'cta_label' => 'Get Started', 'price' => '$50K-$150K', 'timeline' => '6-12 weeks'],
                ['title' => 'Decks and Porches in Madison, CT', 'summary' => 'Composite, PVC, and hardwood outdoor spaces for Madison shoreline properties. Screened porches, pergolas, outdoor kitchens, and multi-level decks built for salt air exposure.', 'image' => '/services/decks-porches-ct.jpg', 'image_alt' => 'Deck and porch construction in Madison CT by BuiltWell', 'url' => '/decks-porches/', 'cta_label' => 'Get Started', 'price' => '$15K-$75K', 'timeline' => '2-4 weeks'],
                ['title' => 'Design and Planning in Madison, CT', 'summary' => 'Space planning, material selection, finish coordination, and project documentation for Madison remodeling projects, with attention to coastal material requirements.', 'image' => '/services/design-planning-ct.jpg', 'image_alt' => 'Remodeling design and planning in Madison CT by BuiltWell', 'url' => '/remodeling-design-planning/', 'cta_label' => 'Get Started', 'price' => '$2.5K-$15K', 'timeline' => '2-6 weeks'],
                ['title' => 'Comfort and Accessibility in Madison, CT', 'summary' => 'Grab bars, roll-in showers, wider doorways, ramp installation, and first-floor adaptations for Madison homeowners planning to age in place on the shoreline.', 'image' => '/services/comfort-accessibility-ct.jpg', 'image_alt' => 'Comfort and accessibility remodeling in Madison CT by BuiltWell', 'url' => '/comfort-accessibility-remodeling/', 'cta_label' => 'Get Started', 'price' => '$5K-$50K', 'timeline' => '1-4 weeks'],
                ['title' => 'Insurance Reconstruction in Madison, CT', 'summary' => 'Rebuilding Madison homes after fire, water, and storm damage. Full reconstruction once cleanup is complete, working directly with your insurance carrier on coastal property claims.', 'image' => '/portfolio/builtwell-contractor-handshake-arrival-ct-optimized.jpg', 'image_alt' => 'Insurance reconstruction contractor in Madison CT by BuiltWell', 'url' => '/insurance-restoration/', 'cta_label' => 'Get Started', 'price' => '$25K-$250K+', 'timeline' => '4-16 weeks'],
            ],
        ],
    ],
    [
        'type' => 'cta_block',
        'data' => [
            'title' => 'Ready to Remodel in Madison?',
            'subtitle' => 'Shoreline homes deserve shoreline-quality craftsmanship. From the Green to the coast, we build it right.',
    ...
    [
        ...
        'data' => [
            ...
            'subtitle2' => 'We serve Madison from our Orange, CT office. We will confirm your appointment within one business day.',
            'images' => [
                ['image' => '/hero/builtwell-team-van-consultation-hero-ct.jpg', 'alt' => 'BuiltWell team van arriving for a consultation'],
                ['image' => '/team/builtwell-owner-handshake-client-ct-02.jpg', 'alt' => 'BuiltWell owner greeting a homeowner for a remodeling consultation'],
            ],
            'fields' => [
...
ApiPageController::forgetCacheForPath('/new-haven-county/madison-ct');
Artisan::call('optimize:clear');

$page = Page::query()->where('full_path', '/new-haven-county/madison-ct')->with(['sections' => fn ($query) => $query->orderBy('sort_order')])->firstOrFail();
