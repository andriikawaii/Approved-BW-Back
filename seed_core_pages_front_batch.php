...
$specFiles = [
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\core-pages-gotov back, treba front (home nista)\\about.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\core-pages-gotov back, treba front (home nista)\\areas-we-serve.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\core-pages-gotov back, treba front (home nista)\\careers.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\core-pages-gotov back, treba front (home nista)\\case-studies-hub.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\core-pages-gotov back, treba front (home nista)\\contact.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\core-pages-gotov back, treba front (home nista)\\fairfield-county-hub.md',
    'C:\\Users\\georg\\Downloads\\builtwell-ct-content-handoff\\content\\core-pages-gotov back, treba front (home nista)\\faq.md',
];
...
foreach ($specFiles as $filePath) {
    ...
    if ($spec['url'] === '/faq' && in_array('faq_list', $allowed, true)) {
        ...
        foreach ($spec['blocks'] as $block) {
            ...
            createRichTextCore($page, $sort, $title, $block['content'], 'default');
            echo "Created: rich_text (" . ($title ?? 'Intro') . ")\n";

            if (
                $spec['url'] === '/fairfield-county' &&
                in_array('town_list', $allowed, true) &&
                $block['title'] === 'Towns We Serve in Fairfield County'
            ) {
                Section::create([
                    'page_id' => $page->id,
                    'type' => 'town_list',
                    ...
                    'data' => [
                        'county' => 'fairfield',
                        'title' => 'Towns We Serve in Fairfield County',
                        'tier1' => [
                            ['label' => 'Greenwich', 'url' => '/fairfield-county/greenwich-ct/'],
                            ['label' => 'Westport', 'url' => '/fairfield-county/westport-ct/'],
                        ],
                        'tier2' => ['Darien', 'New Canaan', 'Stamford', 'Norwalk', 'Fairfield', 'Ridgefield'],
                    ],
                ]);
